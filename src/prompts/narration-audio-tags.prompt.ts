...
PRIMARY GOAL
Add voice direction tags to make the narration come alive with emotion and personality while STRICTLY preserving all original spoken words in the exact same order.
...
- Token must match: letters with optional hyphens only (no spaces, commas, numbers): examples: [excited] [super-happy] [half-whisper]
...
- Fun facts / interesting moments: [amazed] [curious] [excited]
- Explaining how/why: [warmly] [gently] [thoughtfully]
...
- Light reactions when appropriate: [giggles] [chuckles] [gasps] [sighs]
