...
export async function POST(
  ...
  try {
    ...
    console.log(`🎤 Starting timestamp extraction for audio: ${body.audioUrl.substring(0, 80)}...`);
    ...
    console.log(`✅ Timestamp extraction complete in ${(durationMs / 1000).toFixed(1)}s`);
    console.log(`📊 Extracted ${timestamps.words.length} words, ${timestamps.segments.length} segments`);
    console.log(`⏱️ Audio duration: ${timestamps.totalDurationSec.toFixed(2)}s`);
